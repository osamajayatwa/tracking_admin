import 'package:bus_tracking/admin/controllers/auth/verifysignupcontorller.dart';
...
class AdminVerifySignUp extends StatelessWidget {
  const AdminVerifySignUp({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(AdminVerifySignUpControllerImp());
    return Scaffold(
        appBar: AppBar(
            centerTitle: true,
        ...
        body: GetBuilder<AdminVerifySignUpControllerImp>(
