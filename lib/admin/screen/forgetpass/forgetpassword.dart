import 'package:bus_tracking/admin/controllers/forgetpass/forgetpaswwordcontroller.dart';
...
class AdminForgetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(AdminForgetPasswordControllerImp());
    return Scaffold(
        appBar: AppBar(
            centerTitle: true,
        ...
        body: GetBuilder<AdminForgetPasswordControllerImp>(
